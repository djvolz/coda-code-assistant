...
class RepoMap:
    ...
    def __init__(self, root_path: Union[str, Path]):
        ...
        self.stats: Optional[RepoStats] = None
    ...
    def get_language_from_path(self, path: Path) -> Optional[str]:
        """
    ...
    def get_language_stats(self) -> Dict[str, Dict[str, Union[int, float]]]:
        """
    ...
    def get_summary(self) -> Dict[str, Union[int, Dict[str, int]]]:
        ...
        return {
            ...
            'file_extensions': dict(sorted(
                self.stats.file_extensions.items(), 
                key=lambda x: x[1], 
                reverse=True
            )[:10])
        }
