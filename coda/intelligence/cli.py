        ...
        try:
            ...
            if analysis.definitions:
                ...
                for definition in analysis.definitions:
                    result.append(f"  {definition.kind.value}: {definition.name} (line {definition.line})")
    ...
    def _handle_scan(self, args: List[str]) -> str:
        ...
        try:
            ...
            for lang, stats in language_counts.items():
                result.append(f"  {lang}: {stats['files']} files, {stats['definitions']} definitions, {stats['imports']} imports")
            ...
            try:
                ...
                if definitions:
                    ...
                    for definition in definitions:
                        result.append(f"  {definition.file_path}:{definition.line} - {definition.kind.value}")
                    return "\n".join(result)
                else:
