#!/usr/bin/env python3
"""Standalone example showing the intelligence module works without other Coda modules.

This example demonstrates that the intelligence module:
1. Has zero dependencies on other coda modules
2. Can be used in any project for code analysis
3. Provides comprehensive repository intelligence features

Run with: python -m coda.intelligence.example
"""

from pathlib import Path

# Import from the module (when run as python -m coda.intelligence.example)
from coda.intelligence import DependencyGraph, RepoMap, TreeSitterAnalyzer
...
def demonstrate_repo_map() -> None:
    ...
    # Map the intelligence module itself
    module_path = Path(__file__).parent

    # Create a repo map for the intelligence module directory
    ...
    print(f"Found {summary['total_files']} files in the intelligence module")
...
def demonstrate_dependency_graph() -> None:
    ...
    # Analyze Python files in the intelligence module
    module_path = Path(__file__).parent
...
def demonstrate_standalone_usage() -> None:
    ...
    print("\n1. Copy the entire 'intelligence' directory to your project")
    print("\n2. Install optional dependencies (if needed):")
    print("   pip install tree-sitter grep-ast")
    print("\n3. Import and use:")
    print(
        """
    from intelligence import RepoMap, TreeSitterAnalyzer, DependencyGraph
...
def main():
    ...
    print("=== Coda Intelligence Module Demo ===")
    print("\nThis demonstrates the intelligence module working standalone")
    ...
    print("✓ Intelligence module works standalone!")
    print("✓ Zero dependencies on other coda modules")
    print("✓ Can be copy-pasted to any project")
    print("✓ Provides repository mapping and analysis")
