...
from .tree_sitter_analyzer import TreeSitterAnalyzer, FileAnalysis
...
class DependencyGraph:
    ...
    def __init__(self, analyzer: Optional[TreeSitterAnalyzer] = None):
        """
    ...
    def _resolve_dependency(self, dep: str, source_file: str, language: str) -> Optional[str]:
        """
    ...
    def _resolve_python_import(self, dep: str, source_dir: Path) -> Optional[str]:
    ...
    def _resolve_js_import(self, dep: str, source_dir: Path) -> Optional[str]:
    ...
    def _resolve_c_include(self, dep: str, source_dir: Path) -> Optional[str]:
    ...
    def _resolve_java_import(self, dep: str, source_dir: Path) -> Optional[str]:
    ...
    def _resolve_go_import(self, dep: str, source_dir: Path) -> Optional[str]:
    ...
    def _resolve_generic(self, dep: str, source_dir: Path) -> Optional[str]:
    ...
    def get_most_depended_upon(self, limit: int = 10) -> List[Tuple[str, int]]:
        ...
        """
        dependents_count = [(node, len(data.dependents)) 
    ...
    def get_most_dependencies(self, limit: int = 10) -> List[Tuple[str, int]]:
        ...
        """
        dependencies_count = [(node, len(data.dependencies)) 
                            for node, data in self.nodes.items()]
    ...
    def to_dot(self, file_path: Union[str, Path], max_nodes: int = 50) -> None:
        """
