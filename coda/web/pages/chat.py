...
from coda.web.utils.state import get_state_value, set_state_value, clear_chat_state
...
from coda.web.components.file_manager import render_file_upload_widget, render_file_download_section, create_file_context_prompt


def render_provider_selector() -> Optional[str]:
...
def render():
    ...
    if provider and model:
        ...
        st.info("👆 Select a provider and model to start chatting")
