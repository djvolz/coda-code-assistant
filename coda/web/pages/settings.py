...
from coda.configuration import get_config, save_config
...
def render_model_settings():
    ...
    st.info("Models are discovered automatically from each enabled provider. Click 'Refresh Models' to update the available models.")
...
def save_provider_config(config: Dict[str, Any], updates: Dict[str, Any]):
    ...
    from coda.configuration import get_config, save_config as save_global_config
