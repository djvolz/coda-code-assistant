...
Run with: python -m coda.config.example
...
# from config import Config, ConfigManager, ConfigFormat, ConfigPath
try:
    from coda.config import Config, ConfigManager
    from coda.config.models import ConfigFormat, ConfigPath
except ImportError:
