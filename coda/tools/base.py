...
class ToolParameter(BaseModel):
    ...
    min_value: Optional[Union[int, float]] = Field(None, alias="minimum")
    max_value: Optional[Union[int, float]] = Field(None, alias="maximum")
    ...
    def validate_arguments(self, arguments: Dict[str, Any]) -> Optional[str]:
        ...
        for param_name, param_spec in schema.parameters.items():
            ...
            if param_name in arguments:
                ...
                elif param_spec.type == ToolParameterType.NUMBER and not isinstance(value, (int, float)):
