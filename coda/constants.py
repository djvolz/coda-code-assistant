...
ENV_OBSERVABILITY_ENABLED = ENV_PREFIX + "OBSERVABILITY_ENABLED"
ENV_OBSERVABILITY_EXPORT_DIR = ENV_PREFIX + "OBSERVABILITY_EXPORT_DIR"
ENV_METRICS_FLUSH_INTERVAL = ENV_PREFIX + "METRICS_FLUSH_INTERVAL"
ENV_TRACING_SAMPLE_RATE = ENV_PREFIX + "TRACING_SAMPLE_RATE"
ENV_TRACING_MAX_SPANS = ENV_PREFIX + "TRACING_MAX_SPANS"
ENV_TRACING_FLUSH_INTERVAL = ENV_PREFIX + "TRACING_FLUSH_INTERVAL"
ENV_HEALTH_CHECK_INTERVAL = ENV_PREFIX + "HEALTH_CHECK_INTERVAL"
ENV_HEALTH_UNHEALTHY_THRESHOLD = ENV_PREFIX + "HEALTH_UNHEALTHY_THRESHOLD"
ENV_HEALTH_DEGRADED_THRESHOLD = ENV_PREFIX + "HEALTH_DEGRADED_THRESHOLD"
...
OBSERVABILITY_DEFAULT_METRICS_FLUSH_INTERVAL = 300  # 5 minutes
OBSERVABILITY_DEFAULT_TRACING_SAMPLE_RATE = 1.0  # 100% sampling
OBSERVABILITY_DEFAULT_TRACING_MAX_SPANS = 1000
OBSERVABILITY_DEFAULT_TRACING_FLUSH_INTERVAL = 60  # 1 minute
OBSERVABILITY_DEFAULT_HEALTH_CHECK_INTERVAL = 30  # 30 seconds
OBSERVABILITY_DEFAULT_HEALTH_UNHEALTHY_THRESHOLD = 3
OBSERVABILITY_DEFAULT_HEALTH_DEGRADED_THRESHOLD = 5000.0  # 5 seconds
