...
class OCIGenAIModelDiscovery:
    ...
    def discover_models(self, compartment_id: str, 
    ...
    def get_models_by_capability(self, compartment_id: str, 
                                capability: str) -> List[ModelInfo]:
        """
    ...
    def generate_litellm_model_config(self, compartment_id: str, 
                                     service_endpoint: str = None) -> Dict[str, Any]:
        """
        ...
        for model in models:
            ...
            model_config = {
                ...
                "litellm_params": {
                    ...
                    "api_base": service_endpoint or f"https://inference.generativeai.{self.config.get('region', 'us-ashburn-1')}.oci.oraclecloud.com"
                },
                "model_info": {
                    "id": model.id,
                    "display_name": model.display_name,
    ...
    def export_model_registry(self, compartment_id: str, 
                             output_file: str = "oci_genai_models.json") -> None:
        """
