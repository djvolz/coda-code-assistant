...
def list_oci_genai_models_direct(compartment_id: str, 
                                 region: str = "us-ashburn-1",
                                 config_profile: str = "DEFAULT") -> List[Dict[str, Any]]:
    """
...
def list_oci_genai_models_filtered(compartment_id: str,
                                   capability: str = None,
                                   vendor: str = None,
...
def main():
    ...
    chat_models = list_oci_genai_models_filtered(
        compartment_id, 
        capability="CHAT"
    )
    ...
    text_gen_models = list_oci_genai_models_filtered(
        compartment_id, 
