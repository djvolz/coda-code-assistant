...
def get_compartments():
    ...
    try:
        ...
        console.print("Install: https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/cliinstall.htm")
        return None
...
def update_shell_config(compartment_id: str):
    ...
    console.print(f"[yellow]![/yellow] Run 'source {config_file}' to apply changes to current shell")
...
def main():
    ...
    if not compartments:
        ...
        choice = Prompt.ask(
            ...
            choices=[str(i) for i in range(1, len(compartments) + 1)]
        )
