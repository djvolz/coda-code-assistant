...
class TestSelector:
    ...
    def __init__(self, mapping_file: str = "docs/plans/test-infrastructure/module-test-mapping.json"):
    ...
    def _is_critical_file(self, file: str) -> bool:
        ...
        path = Path(file)
        return (
            path.suffix in critical_extensions or
            path.name in critical_names or
            '.github' in file or
            'scripts' in file
        )
