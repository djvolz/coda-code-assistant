...
from coda.providers import OCIGenAIProvider, Message, Role
...
def test_basic_chat():
    ...
    try:
        ...
        # Test chat
        messages = [
            Message(role=Role.USER, content="Hello! Can you tell me a short joke?")
        ]
...
def test_streaming():
    ...
    try:
        ...
        messages = [
            Message(role=Role.USER, content="Count from 1 to 5 slowly, with a word between each number.")
        ]
...
async def test_async_streaming():
    ...
    try:
        ...
        messages = [
            ...
            Message(
                role=Role.USER, 
                content="List 3 colors, one per line."
            )
        ]
...
def main():
    ...
    if not os.path.exists(oci_config_path):
        ...
        console.print("Please configure OCI CLI: https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/cliinstall.htm")
        sys.exit(1)
