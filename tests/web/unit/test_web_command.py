...
class TestWebCommand:
    ...
    def test_web_command_custom_port_and_host(self, runner, mock_config, mock_subprocess, mock_console):
    ...
    def test_web_command_keyboard_interrupt(self, runner, mock_config, mock_subprocess, mock_console):
    ...
    def test_web_command_subprocess_error(self, runner, mock_config, mock_subprocess, mock_console):
        ...
        assert any(
            "Error running web UI" in str(call)
    ...
    def test_web_command_app_path_resolution(self, runner, mock_config, mock_subprocess, mock_console):
    ...
    def test_web_command_all_options_combined(self, runner, mock_config, mock_subprocess, mock_console):
