...
from coda.themes import ConsoleTheme, Theme, THEMES, get_console_theme
...
class TestThemeColors:
    ...
    def test_all_themes_have_conversation_colors(self):
        ...
        for theme_name, theme in THEMES.items():
            assert hasattr(theme.console, 'user_message'), f"{theme_name} missing user_message color"
            assert hasattr(theme.console, 'assistant_message'), f"{theme_name} missing assistant_message color"
            assert theme.console.user_message, f"{theme_name} has empty user_message color"
            assert theme.console.assistant_message, f"{theme_name} has empty assistant_message color"
    ...
    def test_high_contrast_themes_use_bold(self):
        ...
        for theme_name in high_contrast_themes:
            ...
            assert 'bold' in theme.console.user_message or 'bold' in theme.console.assistant_message, \
    ...
    def test_theme_colors_are_valid(self):
        ...
        for theme_name, theme in THEMES.items():
            ...
            for attr_name in ['success', 'error', 'warning', 'info', 
    ...
    def test_get_console_theme_returns_current_theme(self):
        ...
        with patch('coda.themes.get_theme_manager') as mock_get_manager:
            ...
            mock_theme.console = ConsoleTheme(
                user_message="test_blue",
                assistant_message="test_green"
            )
