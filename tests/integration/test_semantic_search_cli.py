...
class TestSemanticSearchCLI:
    ...
    async def test_search_semantic_command(self, command_registry, mock_console):
        ...
        with patch('coda.semantic_search_coda.create_semantic_search_manager', return_value=mock_manager):
            ...
            result = await command_registry.run_command("search", ["semantic", "test", "query"])
    ...
    async def test_search_code_command(self, command_registry, mock_console):
        ...
        with patch('coda.semantic_search_coda.create_semantic_search_manager', return_value=mock_manager):
            ...
            result = await command_registry.run_command("search", ["code", "async", "function"])
    ...
    async def test_search_index_command(self, command_registry, mock_console):
        ...
        with patch('coda.semantic_search_coda.create_semantic_search_manager', return_value=mock_manager):
            with patch('coda.session.get_session_messages', return_value=[
                ...
                # Run index command
                result = await command_registry.run_command("search", ["index", "session"])
    ...
    async def test_search_status_command(self, command_registry, mock_console):
        ...
        with patch('coda.semantic_search_coda.create_semantic_search_manager', return_value=mock_manager):
            # Run status command
            result = await command_registry.run_command("search", ["status"])
    ...
    async def test_search_command_error_handling(self, command_registry, mock_console):
        ...
        with patch('coda.semantic_search_coda.create_semantic_search_manager', 
            ...
            # Run semantic search command
            result = await command_registry.run_command("search", ["semantic", "test"])
    ...
    async def test_search_invalid_subcommand(self, command_registry, mock_console):
        ...
        result = await command_registry.run_command("search", ["invalid"])
