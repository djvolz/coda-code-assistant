...
from coda.agents.types import RunResponse, PerformedAction
from coda.providers.base import ChatCompletion, Tool, ToolCall
...
class TestAgent:
    ...
    async def test_agent_tool_error_handling(self, mock_provider, mock_console):
        ...
        mock_provider.chat.side_effect = [
            ...
            ChatCompletion(
                content="I couldn't complete that action.",
                model="test.model"
            )
        ]
