...
class TestObservabilityCommands:
    ...
    def test_observability_export_with_options(self, mock_manager_class, cli):
        ...
        _output = self.capture_output(cli._cmd_observability, "export --format csv --output /custom/path/export.csv")
    ...
    def test_parse_observability_args(self, cli):
        ...
        test_cases = [
            ...
            ("export --output /tmp/file.json", "export", {"format": "json", "output": "/tmp/file.json"}),
