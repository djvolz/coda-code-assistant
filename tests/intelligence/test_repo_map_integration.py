...
from coda.intelligence.repo_map import RepoMap, FileInfo, RepoStats
...
class TestRepoMapIntegration:
    ...
    def create_test_repo(self):
        ...
        self.create_test_file("src/utils.py", """
        def helper():
            '''Helper function'''
            return 42
        ...
        # JavaScript files
        self.create_test_file("frontend/app.js", """
        ...
        self.create_test_file("frontend/components.js", """
        ...
        # Test files
        self.create_test_file("tests/test_main.py", """
        import pytest
        ...
        # Config files
        self.create_test_file("package.json", """
        {
            "name": "test-project",
            "version": "1.0.0",
            "dependencies": {
        ...
        self.create_test_file("pyproject.toml", """
        [project]
        name = "test-project"
        version = "1.0.0"
    ...
    def test_combined_analysis_workflow(self):
        ...
        for path, analysis in analysis_results.items():
            functions = [d for d in analysis.definitions 
