...
from coda.intelligence.tree_sitter_query_analyzer import TreeSitterQueryAnalyzer, TREE_SITTER_AVAILABLE
...
class TestQueryValidation:
    ...
    def setup_method(self):
        ...
        self.query_dir = Path(__file__).parent.parent.parent.parent / "coda" / "intelligence" / "queries"
        self.analyzer = TreeSitterQueryAnalyzer()
    
    def test_query_files_exist(self):
        """Test that query files exist for documented languages."""
        expected_languages = [
            "python", "javascript", "rust", "go", "java", "c", "cpp",
            "ruby", "csharp", "swift", "dart", "lua", "r"
        ]
    ...
    def test_import_capture_consistency(self):
        ...
        for lang in import_languages:
            ...
            if query_file.exists():
                ...
                assert "@import" in content or "@name.import" in content or "import" in content.lower(), \
