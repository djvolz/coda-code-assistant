    ...
    test_groups = [
        {
            ...
            "command": ["python", "-m", "pytest", str(test_dir / "test_tree_sitter_query_analyzer.py"), "-v"]
        },
        {
            "name": "Integration Tests - RepoMap with TreeSitter",
            "command": ["python", "-m", "pytest", str(test_dir / "test_repo_map_integration.py"), "-v"]
        },
        {
            "name": "Existing TreeSitterAnalyzer Tests",
            "command": ["python", "-m", "pytest", str(test_dir / "test_tree_sitter_analyzer.py"), "-v"]
        }
    ]
