...
class TestTreeSitterQueryAnalyzer:
    ...
    def test_tree_sitter_analysis_with_mock(self):
        ...
        # Create query file
        self.create_query_file("python", "(function_definition name: (identifier) @name.definition.function)")
    ...
    def test_language_detection(self):
        ...
        with patch('coda.intelligence.tree_sitter_query_analyzer.TREE_SITTER_AVAILABLE', True), \
