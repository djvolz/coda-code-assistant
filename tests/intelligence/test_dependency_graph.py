...
class TestDependencyGraph:
    ...
    def test_build_simple_graph(self):
        ...
        # Create test files
        main_py = self.create_test_file("main.py", """
        ...
        utils_py = self.create_test_file("utils.py", """
        def helper_function():
    ...
    def test_dependency_resolution_integration(self):
        ...
        helpers_py = self.create_test_file("helpers.py", """
    ...
    def test_circular_dependency_detection(self):
        ...
        a_py = self.create_test_file("a.py", """
        ...
        b_py = self.create_test_file("b.py", """
    ...
    def test_to_dict(self):
        ...
        # Create simple graph
        analyses = {
            "test.py": self.analyzer.analyze_file(self.create_test_file("test.py", "def func(): pass"))
        }
